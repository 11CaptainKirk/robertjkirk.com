...
const words = ["Engineer", "Designer", "Developer", "Creator", "Entrepreneur"];
const description =
  "I'm a software engineer, designer, and entrepreneur. I build products that solve problems and make people's lives easier.";
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center  relative bg-slate-900 w-full ">
        <div className="h-screen w-full rounded-md bg-neutral-50 dark:bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
          <div className="max-w-2xl mx-auto p-4 flex flex-col gap-4 justify-center items-center">
            {/* <h1 className="relative z-10 text-2xl md:text-9xl  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600  text-center font-sans font-bold ">
              Reach Out
            </h1> */}
            ...
            <p></p>
            <p className="dark:text-neutral-500 text-neutral-700 max-w-lg mx-auto my-2 text-sm md:text-lg text-center relative z-10 animate-fade-in duration-1000">
              I love hearing from other developers, designers, and
              entrepreneurs. If you have a project you'd like to collaborate on,
            ...
            {/* <PinContainer
              title="@11CaptainKirk"
              href="https://github.com/11CaptainKirk"
            >
              <div className="flex  flex-col p-1 tracking-tight text-white sm:basis-1/2 w-[3rem] h-[3rem] ">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
