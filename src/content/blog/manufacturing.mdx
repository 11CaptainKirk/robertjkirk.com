...
<Aside>
  Critically, not automating does not mean not using technology to optimize the process. Fully manual process absolutely can and should use jigs and fixtures to improve quality and speed. Hybrid processes can use automation selectively to improve efficiency of highly stable processes. This does not mean the whole process should be automated to remove human involvement.
</Aside>
